.. _burstcube-hk:
.. |BurstCubeDetectorHk| replace:: :class:`~gdt.missions.burstcube.hk.BurstCubeDetectorHk`

*******************************************************************
BurstCube Detector Housekeeping (:mod:`gdt.missions.burstcube.hk`)
*******************************************************************

|BurstCubeDetectorHk| reads the ``DETECTOR_HK1`` (1 s cadence) and
...
component; :meth:`~gdt.missions.burstcube.hk.BurstCubeDetectorHk.peak_threshold`
and :meth:`~gdt.missions.burstcube.hk.BurstCubeDetectorHk.base_threshold` are
...
member:
    ...
    >>> hk = BurstCubeDetectorHk.open('bc240530csa.hk.gz')
